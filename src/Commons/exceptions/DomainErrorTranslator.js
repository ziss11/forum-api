...
DomainErrorTranslator._directories = {
    'NEW_AUTH.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
        'harus mengirimkan accessToken dan refreshToken'
    ),
    'NEW_AUTH.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
        'accessToken dan refreshToken harus string'
    ),
    ...
    'DELETE_AUTHENTICATION_USE_CASE.PAYLOAD_NOT_MEET_DATA_TYPE_SPECIFICATION':
        new InvariantError('refresh token harus string'),
    'ADDED_COMMENTS.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
        'tidak dapat menambahkan komentar karena properti yang dibutuhkan tidak ada'
    ),
    'ADDED_COMMENTS.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
    ...
    'ADDED_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
        'tidak dapat menambahkan thread karena properti yang dibutuhkan tidak ada'
    ),
    'ADDED_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
        'tidak dapat menambahkan thread karena tipe data tidak sesuai'
    ),
    ...
    'ADDED_REPLY.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
        'tidak dapat menambahkan reply karena properti yang dibutuhkan tidak ada'
    ),
    ...
    'ADD_COMMENTS.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError(
        'tidak dapat menambahkan komentar karena properti yang dibutuhkan tidak ada'
    ),
    'ADD_COMMENTS.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError(
        'tidak dapat menambahkan komentar karena tipe data tidak sesuai'
    ),
};
