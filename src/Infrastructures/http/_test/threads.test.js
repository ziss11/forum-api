...
describe('/threads endpoint', () => {
    ...
    describe('when POST /threads/{id}/comments', () => {
        it('should response 201 and persisted comment', async () => {
            ...
            const threadId = await ServerTestHelper.getThreadHelper({
                server,
                accessToken,
            });
    ...
    describe('when DELETE /threads/{threadId}/comments/{commentId}', () => {
        it('should response 200 if comment deleted', async () => {
            ...
            const commentId = await ServerTestHelper.getCommentHelper({
                server,
                accessToken,
                threadId,
            });
    ...
    describe('when GET /threads/{threadId}', () => {
        it('should response 200 and detail thread', async () => {
            ...
            await ServerTestHelper.getCommentHelper({
                server,
                accessToken,
                threadId,
            });
        ...
        it('should show **komentar telah dihapus** when get deleted comment', async () => {
            ...
            const commentId1 = await ServerTestHelper.getCommentHelper({
                server,
                accessToken,
                threadId,
            });
            ...
            await ServerTestHelper.deleteThreadCommentHandler({
                server,
                accessToken,
                threadId,
        ...
        it('should show **balasan telah dihapus** when get deleted reply', async () => {
            ...
            const replyId1 = await ServerTestHelper.getReplyHelper({
                server,
                accessToken,
                threadId,
                commentId,
            });
            await ServerTestHelper.getReplyHelper({
                server,
                accessToken,
                threadId,
                commentId,
            });
            await ServerTestHelper.deleteCommentsReplyHandler({
                server,
                accessToken,
                threadId,
                commentId,
    ...
    describe('when DELETE /threads/{threadId}/comments/{commentId}/replies/{replyId}', () => {
        it('should response 200 if reply deleted', async () => {
            ...
            const replyId = await ServerTestHelper.getReplyHelper({
                server,
                accessToken,
                threadId,
                commentId,
