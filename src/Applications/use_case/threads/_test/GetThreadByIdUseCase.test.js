...
describe('GetThreadByIdUseCase', () => {
    it('should disguise comment and reply content when isDelete is true', async () => {
        // Arrange
        ...
        mockReplyRepository.getCommentsReplyByThreadId = jest
            .fn()
        ...
        expect(mockReplyRepository.getCommentsReplyByThreadId).toBeCalledWith(
            threadId
        );
    });
