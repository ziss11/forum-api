...
DomainErrorTranslator._directories = {
  'NEW_AUTH.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('harus mengirimkan accessToken dan refreshToken'),
  'NEW_AUTH.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('accessToken dan refreshToken harus string'),
