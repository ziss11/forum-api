...
describe('ReplyRepository postgres', () => {
    ...
    describe('getCommentsReplyByThreadId function', () => {
        ...
        it('should get comments reply by thread id correctly', async () => {
            ...
            // Action
            const result =
                await replyRepositoryPostgres.getCommentsReplyByThreadId(
                    threadId
                );
            // Assert
    ...
    describe('verifyReplyOwner function', () => {
        ...
        it('should get comments reply by thread id correctly when user is owner', async () => {
            ...
            // Action
            const addedReply = await replyRepositoryPostgres.verifyReplyOwner(
                commentId,
                replyId,
                owner
            );
        ...
        it('should throw NotFoundError when comment not found', async () => {
            ...
            // Action
            const addedReply = replyRepositoryPostgres.verifyReplyOwner(
                commentId,
                replyId,
                owner
            );
        ...
        it('should throw AuthorizationError when user not owner', async () => {
            ...
            // Action
            const result = replyRepositoryPostgres.verifyReplyOwner(
                commentId,
                replyId,
                'user-321'
            );
    ...
    describe('addCommentsReply', () => {
        ...
        it('should persist add reply comments and return added reply correctly', async () => {
            ...
            // Action
            await replyRepositoryPostgres.addCommentsReply({
                owner,
                commentId,
                content,
            });
